...
export default function ListaRegistrosAgua({ refreshKey }) {
  ...
  useEffect(() => {
    ...
    setLoading(true);
    base44.entities.RegistroAgua.filter({ business_id: currentBusiness.id }, "-fecha", 200)
              ...
              <div className="flex items-start justify-between">
                <div className="flex-1">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <span className={`text-xs px-2 py-0.5 rounded-full font-medium ${correcto ? "bg-[#e6f5ed] text-[#2d8a5e]" : "bg-red-50 text-red-500"}`}>
                      {correcto ? "Correcto" : "Fuera de rango"}
                    </span>
                  </div>
                  ...
                  <div className="flex gap-4 mb-2">
                    {r.cloro_nivel != null && (
                      <div>
                        ...
                        <p className="text-xl font-bold text-[#6BB68A]">{r.cloro_nivel} ppm</p>
                      </div>
                    )}
                    {r.ph_nivel != null && (
                      <div>
                        <p className="text-xs text-muted-foreground">pH</p>
                        <p className="text-xl font-bold text-foreground">{r.ph_nivel}</p>
                      </div>
                    )}
                  </div>
                  ...
                  <p className="text-sm text-foreground mt-1">
                    <span className="font-semibold">Propiedades organolépticas: </span>
                    {r.propiedades_organolepticas
                      ? <span className="text-[#6BB68A]">✓ Correctas</span>
                      : <span className="text-red-500">✗ Incorrectas</span>}
                  </p>

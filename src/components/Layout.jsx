  ...
  return (
    <div className="flex h-screen overflow-hidden bg-background">
      ...
      <aside
        ...
        {/* Logo */}
        <div className={cn("pt-7 pb-6 shrink-0 flex items-center justify-center border-b border-white/10 transition-all duration-300", sidebarCollapsed ? "px-2" : "px-6 bg-white")}>
          {sidebarCollapsed ? (
